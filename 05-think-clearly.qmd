...
### Diagnose the current state to understand what is happening and why **(0)** 🔺
...
### Define the problem (the gap between current and desired state) **(1)** 🔺
...
### Frame the problem: articulate the decision set, constraints, and scope **(1)** 🔺
...
### State a provisional Day-1 hypothesis about which decision to make 🔺
...
### Articulate explicit "what would have to be true" hypotheses **(3)** 🔺
...
### Disaggregate hypotheses into MECE issues **(2)** ◯ ◯
...
### Prioritize issues based on decision impact **(3)** ◯ ◯
...
### Explicitly exclude questions that wouldn't change the decision
