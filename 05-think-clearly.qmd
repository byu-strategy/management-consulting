...
## Session 4 Activity: Diagnose the Current State {#session-4}
...
::: {.callout-tip collapse="true"}
## Session 5 Activity: Root Cause Analysis {#session-5}
...
::: {.callout-tip collapse="true"}
## Session 6 Activity: Define the Problem {#session-6}
...
::: {.callout-tip collapse="true"}
## Session 7 Activity: Frame the Decision {#session-7}
...
::: {.callout-tip collapse="true"}
## Session 8 Activity: Hypothesize & WWHTBT {#session-8}
...
::: {.callout-tip collapse="true"}
## Session 9 Activity: MECE & Prioritization {#session-9}
