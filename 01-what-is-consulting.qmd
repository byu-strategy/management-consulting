...
Management Consulted's [Firm Directory](https://managementconsulted.com/consulting-firms/) and [Top Consulting Firms](https://managementconsulted.com/top-consulting-firms/) list provide detailed profiles to help you research firms by type, specialty, and culture.
:::
...
::: {#activity-getting-started-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Research Target Firms
...
::: {#activity-getting-started-client .callout-tip collapse="true"}
## Client Work Activity: Select Your Target Company
