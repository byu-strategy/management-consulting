...
::: {#session-27 .callout-tip collapse="true"}
## Session 27 Activity: The Full OS in Action

### Recruiting: Course reflection & next steps

Reflect on your journey through *The Consultant's OS* and plan your next steps in recruiting.

```bash
Help me reflect on my recruiting journey and plan next steps:

**OS Skills Assessment**
Rate my progress on each imperative (1-5, where 5 = job-ready):

**Think Clearly**
- Problem structuring: [1-5]
- Hypothesis development: [1-5]
- MECE thinking: [1-5]

**Get to the Right Answer**
- Market sizing: [1-5]
- Research and synthesis: [1-5]
- Estimation under pressure: [1-5]

**Move Work Forward**
- Working with ambiguity: [1-5]
- Managing time and priorities: [1-5]

**Create Impact**
- Behavioral stories: [1-5]
- Confident delivery: [1-5]
- Executive communication: [1-5]

**Recruiting Progress Summary**
- Networking conversations completed:
- Cases practiced:
- Resume status:
- Target firms:
...
**Gaps to Close**
Based on my assessment, what are my top 3 areas to improve before real interviews?

**Summer/Next Steps Plan**
- If I have offers: How will I prepare for Day 1?
- If I'm still recruiting: What's my plan for the next recruiting cycle?
- Ongoing development: How will I continue building these skills?
...
### Client Work: Capstone Presentations

Present your capstone and demonstrate the full OS in action.

```bash
Help me prepare for my capstone presentation:

**Pre-Presentation Checklist**

**Storyline**
- [ ] Our main recommendation is crystal clear
- [ ] The SCQA flow makes sense
...
- [ ] We have consistent messaging
- [ ] We've rehearsed with timing

**Q&A Preparation**
- [ ] We've listed the 10 hardest questions we might get
- [ ] We know who answers what
- [ ] We have backup data ready
- [ ] We've practiced handling pushback

**Delivery**
- [ ] Each person knows their key points cold
- [ ] We're making eye contact, not reading slides
- [ ] Our pace is appropriate (not rushing)
- [ ] We sound confident but not arrogant

**Last-Minute Polish**
What final improvements should we make to the deck or our delivery?
...
- How did we demonstrate *The Consultant's OS*?
```
:::
