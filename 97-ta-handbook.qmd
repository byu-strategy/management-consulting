...
|:-----------|:-------|:--------|
| Goals Worksheet + Chat | Early semester | Establish recruiting goals and development focus |
| TA Mentoring Session 1 | After goals chat | Baseline practice interview, identify focus areas |
| TA Mentoring Session 2 | Mid-semester | Progress check practice interview, calibrated feedback |
| TA Mentoring Session 3 | End of semester | Final practice interview evaluation with full context |
...
- **Session 3**: "Did you achieve what you defined as success in your goals chat?"
...
|---------|--------|-------|
| **Session 1** | After goals chat | Baseline assessment—identify strengths and focus areas |
| **Session 2** | Mid-semester | Progress check—compare to baseline, calibrate feedback |
| **Session 3** | End of semester | Final evaluation—assess growth, prepare for real interviews |
...
|:------------|:----|:------|:-----|:------------|
| **[P1: Intelligence Brief](00-assessments.qmd#intelligence-brief)** | See Canvas | Outside-in analysis surfacing a key tension | Individual | Present (25 pts) + Feedback (15 pts) |
| **[P2: Point of View](00-assessments.qmd#point-of-view)** | See Canvas | Take a position on what the company should do | Individual | Present (25 pts) + Feedback (15 pts) |
| **[Capstone: Conversation Deck](00-assessments.qmd#conversation-deck)** | See Canvas | Polished deck + real outreach | Individual | Deck (60 pts) + Feedback (20 pts) + Outreach (20 pts) |
...
- [Case Interviews](00-assessments.qmd#case-interviews): Scoring rubrics and interview guidance
- Grading rubrics: Available in Canvas
