**Subject:** Final Two Weeks: Capstone Changes, Due Dates, and What to Turn In
...
- EJ: W240
- Grant: TNRB 587
- Avery: Schedule something at a separate time over Zoom or reach out to me if you would like to meet. 

**New Capstone due date: Monday, April 20 at 11:59 PM.** This gives you several extra days beyond the original Thursday deadline to polish your deck. Submit your final deck as a PDF to Canvas. Sharing your deck with somebody at your company and asking for a meeting is now extra credit, +5 points) if you submit a screenshot of your outreach on Canvas. Same due date as slide deck. 
...
- [How to Write Slide Action Titles](https://slideworks.io/resources/how-to-write-action-titles-like-mckinsey)
- [Getting to the "So What"](https://slideworks.io/resources/getting-to-so-what-guide-to-creating-actionable-business-insights)
- [How to Write an Effective Executive Summary](https://slideworks.io/resources/how-to-write-executive-summary)
- [How Management Consultants Make Presentations](https://slideworks.io/resources/how-mckinsey-consultants-make-presentations)

**Capstone reminders:**

- Your deck should read as a standalone professional document. No references to P1, P2, or STRAT 325.
- Include your name and email on the title slide.
- Every slide with a data driven claim needs a traceable source in the footnote (named report, filing, or database, etc).
- Include a sources page in your appendix with enough detail that a reader could find each source. See the [Sourcing Guide](https://byu-strategy.github.io/management-consulting/00-assessments.html#rubric-evidence) in the rubric for examples of what goes on-slide vs. in the appendix.
