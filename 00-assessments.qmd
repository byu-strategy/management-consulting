...
Scored by the professor. Each dimension is scored on a 7-point scale, then converted to 50 points using the formula below.

**Storyline & Structure (40%)**: *Does the deck tell a logical, answer-first story?*

| Rating | Description |
|--------|-------------|
| 7 | Reading only the action titles tells the complete story. Clear arc from insight through opportunity to ask. Reads as a professional document with no assignment artifacts, and includes your name and contact information. |
...
**Analytical Depth (40%)**: *Would someone at this company actually learn something new?*

::: {.callout-important}
## Source Quality Gate

Any slide that cites a number must include a traceable source: a named report, filing, earnings call, survey, or database. "Web research," "various sources," "analyst estimates" (without naming the analyst), and "proprietary analysis" (without showing assumptions) are not traceable sources. Unverifiable sourcing on key claims caps the Analytical Depth score at 4, regardless of how strong the insight is.
:::
...
| 5 | Good analysis with a clear point of view. Evidence supports the argument but relies on one or two unsupported leaps or round-number estimates. All key claims have traceable sources. |
| 4 | Adequate analysis, but evidence is thin in places. Numbers may be internally inconsistent across slides, or key sources are vague or unverifiable ("web research," "analyst estimates," "proprietary modeling"). |
...
**Slide Design (20%)**: *Is the deck visually clear and professional?*
...
**The Deck (5-10 slides + appendix)** (title slide, appendix, and transition slides not counted)
