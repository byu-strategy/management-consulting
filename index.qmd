...
Welcome to *Intro to Management Consulting*. This course prepares students to successfully secure a management consulting interview, perform well in the interview, and to excel during their first year as a management consultant. The course is designed for sophomores in order to prepare them for consulting firms' early recruiting cycle. Students will develop the core consulting toolkit, including problem decomposition, structured communication, and presentation skills. These skills will be applied to real-world consulting scenarios helping students build the skills and confidence needed to thrive in top-tier consulting roles.

## Learning Outcomes

| **Learning Outcome** | **Target BYU Aim(s)** |
|-------------------------------------|--------------------------|
| Students will demonstrate the ability to decompose complex business problems into structured, solvable components using consulting frameworks. | Intellectually Enlarging |
| Students will craft and deliver persuasive, structured communication tailored to client and team settings. | Intellectually Enlarging; Character Building |
| Students will practice and reflect on principles of Christlike leadership, including integrity, humility, and service, as applied in consulting settings. | Spiritually Strengthening; Character Building |
| Students will collaborate effectively in teams. | Character Building |
| Students will articulate how consulting skills (problem-solving, communication, ethical decision-making) can be used to render service to others. | Spiritually Strengthening; Lifelong Learning and Service |
