...
### 2.1 Design analyses to confirm or falsify priority hypotheses **(5)** 🔺
...
### 2.4 Perform back-of-envelope calculations to bound answers **(5)**
...
### 2.6 Synthesize analytical results into clear answers to the decision **(6)** 🔺
