---
title: "Get to the Right Answer"
---

**Guiding Question:** What do the facts and data actually say?

The second imperative is about finding truth. You've structured the problem—now you need to answer it with evidence, not opinion.

## Core Actions

### Design analyses to confirm or falsify priority hypotheses **(5)** 🔺

*Toolkit: Analytics & Modeling*
...
### Build an outside-in fact base using best-available data **(5)**
...
| Recruiting Application | Client Work Application |
|:-----------------------|:------------------------|
| Research firms, roles, and people before outreach—know who you're talking to | Build a fact base from filings, news, competitor data, industry reports |
...
### State assumptions explicitly and identify appropriate proxies **(5)** ◯ ◯
...
### Perform back-of-envelope calculations to bound answers **(5)**
...
### Build models and run sensitivities **(5)** ◯ ◯
...
### Synthesize analytical results into clear answers to the decision **(6)** 🔺
