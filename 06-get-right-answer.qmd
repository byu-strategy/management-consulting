...
::: {#activity-outside-in-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Research Firms and People Before Outreach
...
::: {#activity-outside-in-client .callout-tip collapse="true"}
## Client Work Activity: Build Fact Base for P1
...
**Example: Smoothie Cups in Manhattan**

- Population of Manhattan: ~1.6M
- % who drink smoothies: ~20% = ~320K smoothie drinkers
- Cups per day: ~1 = ~320K cups/day
- Add commuters/tourists: +50% = ~480K cups/day

::: {#activity-quick-math-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Market Sizing Under Pressure
...
::: {#activity-quick-math-p2 .callout-tip collapse="true"}
## Client Work Activity: Size the Strategic Opportunity for P2

*Supports: P2 Point of View*

Quantify the opportunity or impact of your P2 recommendation. A compelling POV needs numbers.

```bash
Help me size the strategic opportunity for my P2 on [COMPANY NAME]:

**What I'm Sizing**
[Describe: e.g., "revenue potential from entering new segment," "cost savings from operational improvement," "market share gain from competitive repositioning"]

**Why This Matters for P2**
How does this sizing support my P2 recommendation?

**Sizing Approach**
1. **Top-Down Approach**
   - Total addressable market: [Size]
   - Serviceable market (realistic filters): [Size]
   - Company's realistic capture: [% and $]

2. **Bottom-Up Approach**
   - Key drivers: [customers × units × price]
   - Estimate each with explicit assumptions
   - Build to total opportunity

**My Assumptions**
For each key assumption:
- State the assumption
- Rationale (where does this come from?)
- Confidence level (high/medium/low)
- What data would validate it?

**Sensitivity Check**
- What are the 2-3 assumptions that most affect the answer?
- What's the range if key assumptions are off by 50%?

**P2 Integration**
- What's my point estimate?
- Is this opportunity "big enough" to warrant the company's attention?
- How does this strengthen my P2 recommendation?
```
:::
...
::: {#activity-synthesize-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Case—Driving to a Recommendation
...
::: {#activity-synthesize-client .callout-tip collapse="true"}
## Client Work Activity: Synthesize Research into Insights

*Supports: P1 Intelligence Brief, P2 Point of View*
...
::: {#activity-synthesis-workshop-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Rapid Synthesis Exercises
...
::: {#activity-synthesis-workshop-client .callout-tip collapse="true"}
## Client Work Activity: P1 Workshop—1-Page Diagnostic

*Supports: P1 Intelligence Brief*

Apply synthesis skills to create your P1 Intelligence Brief deliverable.
...
1. **Market sizing**: Estimate the annual revenue of smoothie shops within 1 mile of BYU campus
