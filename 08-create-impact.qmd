...
1. [BCG's Approach to Great Slides — Practical Guide from a Former Consultant](https://slideworks.io/resources/bcg-approach-to-great-slides-practical-guide-from-former-consultant#what-are-the-components-of-a-great-presentation) — What makes a consulting slide effective: structure, action titles, and visual logic.
2. [The McKinsey Problem-Solving Process](https://slideworks.io/resources/mckinsey-problem-solving-process) — How McKinsey structures problem-solving from problem definition through communication.
:::
...
::: {#activity-storylines-recruiting .callout-tip collapse="true"}
## Recruiting Activity: PARADE Structure for Behavioral Stories
...
::: {#activity-storylines-client .callout-tip collapse="true"}
## Client Work Activity: SCQA for P2 Storyline

*Supports: P2 Point of View*

Use SCQA to structure the storyline for your P2 Point of View.
...
1. [Getting to the "So What" — A Guide to Creating Actionable Business Insights](https://slideworks.io/resources/getting-to-so-what-guide-to-creating-actionable-business-insights) — How to move beyond observations to actionable recommendations using the "Five Whys" technique.
:::
...
::: {#activity-executive-brevity-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Crisp 2-Minute Behavioral Answers
...
::: {#activity-executive-brevity-client .callout-tip collapse="true"}
## Client Work Activity: 30-Second and 2-Minute Recommendations

*Supports: Capstone Presentation*
...
::: {#activity-confident-delivery-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Behavioral Interview Simulation
...
::: {#activity-confident-delivery-client .callout-tip collapse="true"}
## Client Work Activity: Capstone Structure Workshop

*Supports: Capstone Presentation*

Apply communication principles to structure your Capstone presentation.

```bash
Help me create my Capstone presentation structure for [COMPANY NAME]:
...
::: {#activity-tailor-pushback-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Handle Difficult Fit Questions

*Supports: Practice Interviews (Fit)*
...
::: {#activity-tailor-pushback-client .callout-tip collapse="true"}
## Client Work Activity: Prewiring & Yes-No-Yes for Objections
...
::: {#activity-build-trust-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Trust Equation for Networking & Fit Interviews

*Supports: Networking Tracker, Practice Interviews (Fit)*

Use the Trust Equation to prepare for networking conversations and fit interviews.

```bash
Help me prepare for a networking conversation using the Trust Equation:
...
**Character Dimensions for Fit Interviews**
...
**Group Settings: Info Sessions & Group Interviews**

In group settings, firms evaluate how you work with others. Apply the Trust Equation while demonstrating collaboration:

```bash
Help me prepare for a group recruiting event:

**Event Context**
- Type: [Info session / Group case / Networking event]
- Format: [What will happen]

**Trust Equation in Groups**
- Credibility: Contribute substantively, but don't dominate
- Reliability: Follow through on any commitments made in the room
- Intimacy: Build genuine connections, not transactional ones
- Low Self-Orientation: Help the group succeed; build on others' ideas

**Collaboration Signals**
What behaviors will show I'm a team player?
- Active listening: [How I'll show engagement]
- Building on ideas: [Phrases like "Building on what X said..."]
- Supporting others: [How I'll acknowledge good points]
- Leading when needed: [How I'll step up appropriately]

**If Attending with Classmates**
- How can we support each other without looking rehearsed?
- How do we avoid competing or undermining each other?
```
:::

::: {#activity-build-trust-client .callout-tip collapse="true"}
## Client Work Activity: Stakeholder Trust Mapping
...
1. [The Pyramid Principle — Consulting Toolbox (with Examples)](https://slideworks.io/resources/the-pyramid-principle-mckinsey-toolbox-with-examples) — Barbara Minto's framework for structuring communication: lead with the answer, support with grouped arguments.
:::
...
::: {#activity-coordinate-team-client .callout-tip collapse="true"}
## Client Work Activity: Capstone Team Coordination
...
::: {#activity-seek-feedback-recruiting .callout-tip collapse="true"}
## Recruiting Activity: Process Interview Feedback
...
::: {#activity-seek-feedback-client .callout-tip collapse="true"}
## Client Work Activity: Revise Deliverables Based on Feedback

*Supports: P1, P2, Capstone*
